...
public class InfluencerCalculatorTest extends TestCase {
    ...
    public void setUp() {
        ...
        infl1 = new Influencer("january", "bob", "aaaaaaaa", "US", "food", 1776,
            88, 10000, 150, 70);
        infl2 = new Influencer("january", "bob", "bob", "US", "food", 164, 88,
            1007, 12, 100);
        infl3 = new Influencer("january", "bob", "croatia", "US", "food", 176,
            88, 106, 12, 73);
        infl4 = new Influencer("january", "bob", "swindon", "US", "food", 1, 8,
            10, 15, 7);
        infl5 = new Influencer("january", "bob", "zzzzzzzz", "US", "food",
